      ...
      <div className="footer-inner">
        <div className="container footer-grid">
          <div className="footer-brand">
            <img src={logoImage} alt="Intellect Circle" className="logo-img" style={{ marginBottom: '18px', filter: 'brightness(0) invert(1)', maxHeight: '80px', opacity: 0.9 }} />
            <p className="footer-tagline">
              A structured learning community for young intellects. From your street — to the world.
            </p>
            <div className="footer-socials">
              ...
              {contact.twitter && (
                <a href={contact.twitter} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Twitter / X">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <div className="footer-navigation">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/assistant" onClick={(e) => { e.preventDefault(); navigateTo('assistant'); }}>AI Assistant</a></li>
          ...
          <div className="footer-actions-links">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/verify" onClick={(e) => { e.preventDefault(); navigateTo('verify'); }}>Verify Certificate</a></li>
            </ul>
          </div>
        </div>
